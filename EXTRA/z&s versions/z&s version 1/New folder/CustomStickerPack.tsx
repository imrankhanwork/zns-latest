...
const CustomStickerPack = () => {
  ...
  const product = {
    ...
    description: 'Personalized sticker collections with unique designs. Perfect for laptops, water bottles, and personal items. Waterproof and fade-resistant.',
    rating: 4.8,
    inStock: true
  };
    ...
    <PageLayout title={product.name}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="relative aspect-square bg-gradient-to-br from-green-400 via-cyan-500 to-blue-600 rounded-lg overflow-hidden">
            <img
              src={product.image}
              alt={product.name}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              <li>• Pack of 20+ unique stickers</li>
              <li>• Waterproof and fade-resistant</li>
              <li>• Perfect for laptops and water bottles</li>
...
export default CustomStickerPack;
