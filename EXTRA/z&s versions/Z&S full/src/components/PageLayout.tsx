...
import { Moon, Sun, ChevronDown, ShoppingCart, ArrowLeft } from 'lucide-react';
...
const PageLayout: React.FC<PageLayoutProps> = ({ title, children, showBackButton = false }) => {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <main className="container mx-auto px-4 py-8">
        {showBackButton && (
          <Button variant="ghost" size="sm" onClick={() => navigate(-1)} className="mb-6 flex items-center gap-2">
