...
const lightModeProducts = [
  {
    ...
    description: 'Collection of bold and vibrant stickers',
    cardBg: {
  ...
  {
    id: 2,
    name: 'T-shirt white Print',
    description: 'white anime print t-shirt showcases',
    cardBg: {
  ...
  {
    id: 3,
    name: 'Mousepad Airplane Print',
    description: 'Starry Sky Airplane Mouse Pad',
    cardBg: {
    ...
    productId: 'mouse-pad-2'
  },
  {
    id: 4,
    name: 'iPhone 16 Pro Skin',
    description: 'Premium carbon fiber anime skin for iPhone 16 Pro',
    cardBg: {
  ...
  },
  {
    ...
    description: 'Sleek and minimal gray laptop skin designed for Apple devices',
    cardBg: {
      light: 'from-green-400 via-cyan-500 to-blue-600',
      dark: 'from-slate-700 via-gray-700 to-zinc-800'
    },
    backgroundImage: '/assets/laptop_white_bg.png',
    productImage: '/assets/laptop_white_fg.png',
    productId: 'laptop-1'
  }
];
...
const darkModeProducts = [
  {
    id: 6,
    name: 'Mousepad High-speed',
    description: 'High-speed style for your desk',
    cardBg: {
    ...
    productId: 'mouse-pad-3'
  },
  {
    id: 7,
    name: 'T-shirt Dark dragon',
    description: 'Black dragon printed t-shirt ',
    cardBg: {
  ...
  {
    id: 8,
    name: 'San Andreas Stickers',
    description: 'Iconic San Andreas stickers pack',
    cardBg: {
  ...
  },
  {
    ...
    description: 'black laptop skin featuring a striking golden flying warrior design',
    cardBg: {
  ...
  },
  {
    ...
    description: 'Premium anime skin for iPhone 16 Pro.',
    cardBg: {
